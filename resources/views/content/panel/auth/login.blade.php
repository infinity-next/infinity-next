...
<form class="form-auth" role="form" method="POST" action="{{ url('/cp/auth/login') }}">
	...
	<fieldset class="form-fields">
		<legend class="form-legend">@lang('panel.field.login')</legend>
		
		<div class="field row-username">
			<label class="field-label" for="username">@lang('panel.field.uid')</label>
		...
		<div class="field row-forgot">
			<a href="{{ url('/cp/password/email') }}">@lang('panel.field.login_link.password_forgot')</a>
		</div>
		
		<div class="field row-register">
			<a href="{{ url('/cp/auth/register') }}">@lang('panel.field.login_link.register')</a>
		</div>
		
		<div class="field row-submit">
			<button type="submit" class="field-submit">@lang('panel.field.login')</button>
			<label class="field-label-inline"><input type="checkbox" name="remember"/> @lang('panel.field.remember')</label>
		</div>
	</fieldset>
</form>
@endsection
