...
@section('body')
<form class="form-pw grid-33" role="form" method="POST" action="{{ url('/cp/password/') }}">
	...
	<fieldset class="form-fields">
		...
		<div class="field row-password">
			<label class="field-label" for="password">@lang('panel.field.password_current')</label>
			<input class="field-control"  id="password" name="password" type="password" />
		</div>
		
		<div class="field row-password_new">
			<label class="field-label" for="password_new">@lang('panel.field.password_new')</label>
		...
		<div class="field row-password_new_copassword_new_confirmationnfirm">
			<label class="field-label" for="password_new_confirmation">@lang('panel.field.password_new_confirm')</label>
