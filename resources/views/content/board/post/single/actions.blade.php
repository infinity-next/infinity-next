...
<div class="post-action-bar action-bar-mod">
	...
	<div class="post-action-tab action-tab-actions" data-no-instant>
		<span class="post-action-label post-action-open"><i class="fa fa-bars"></i><span class="post-action-text">@lang('board.action.open')</span></span>
		...
		<ul class="post-action-groups">
			<li class="post-action-group">
				...
				<ul class="post-actions">
					...
					@if (isset($details['author_ip']) and !is_null($details['author_ip']))
					...
					@endif
					@if ($user->canViewGlobalHistory() and $details['author_ip'] instanceof \App\Support\IP)
					@set('postActions', true)
					<li class="post-action">
