<div class="infobox" id="site-statistics">
	...
	<div class="infobox-info">
		<p>@choice('index.info.statistic.boards', $stats['boardIndexedCount'], [
			'boards_public' => \Lang::choice('index.info.statistic.board_count', $stats['boardIndexedCount'], [
				'boards' => $stats['boardIndexedCount'],
			]),
			'boards_total' => \Lang::choice('index.info.statistic.board_count', $stats['boardTotalCount'], [
