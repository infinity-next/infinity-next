    ...
    <section class="cp-linklists">
        <ul class="cp-linkgroups">
            ...
            <li class="cp-linkgroup">
                ...
                <ul class="cp-linkitems">
                    <li class="cp-linkitem">
                        <a class="linkitem-name" href="{!! url('panel.bans.check') !!}">@lang('nav.panel.secondary.home.banned')</a>
                    </li>

                    <li class="cp-linkitem">
                        <a class="linkitem-name" href="{!! url('panel.bans') !!}">@lang('nav.panel.secondary.home.bans')</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="cp-linkgroup">
                ...
                <ul class="cp-linkitems">
                    <li class="cp-linkitem">
                        <a class="linkitem-name" href="{!! secure_url('panel.donate') !!}">@lang('nav.panel.secondary.home.donate')</a>
                    </li>
                </ul>
            </li>
            @endif
