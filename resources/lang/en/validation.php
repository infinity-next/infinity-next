...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'new_board_flags.file.*.dimensions' => "Flags must be at most :max_heightpx tall and :max_widthpx wide, or an SVG.",
        ...
        // post moderation
        'ban.required_if' => "You must either delete the post or apply a ban.",
    ],
