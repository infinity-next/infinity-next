...
abstract class BC
{
     ...
     *
     * @param int $bits Total bits to shift
     */
     ...
     * < = > the RIGHT.
     *
     * @param string|int $left  Left side operand
     * @param string|int $right Right side operand
     *
     * @return int Return -1,0,1 for <=> comparison
     */
