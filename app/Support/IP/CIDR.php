...
class CIDR
{
     ...
     *
     * @return int Returns an INTERSECT_* constant
     *
     ...
     * @param int|null $bits If /bits is not specified on string they can be
     ...
     * @param int    $bits Maximum bits to check; defaults to 32 for IPv4 and 128 for IPv6
     */
     ...
     * @param int   $maxPrefix Maximum prefix to allow
     *
     ...
     * possible.
     *
     * @param int $prefix  CIDR prefix bits (0-128)
     * @param int $version IP version. If null the version will be detected
