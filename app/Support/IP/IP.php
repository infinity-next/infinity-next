...
abstract class IP
{
     ...
     * @param int     $version Force IP version to 4 or 6. Leave null for automatic.
     */
     ...
     *
     * @return int Return -1,0,1 depending if $ip1 is <=> $ip2
     */
